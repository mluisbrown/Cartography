...
///
@discardableResult public func inset(_ edges: Edges, _ all: CGFloat) -> Expression<Edges> {
...
/// - returns: A new expression with the inset edges.
///
@discardableResult public func inset(_ edges: Edges, _ horizontal: CGFloat, _ vertical: CGFloat) -> Expression<Edges> {
...
/// - returns: A new expression with the inset edges.
///
@discardableResult public func inset(_ edges: Edges, _ top: CGFloat, _ leading: CGFloat, _ bottom: CGFloat, _ trailing: CGFloat) -> Expression<Edges> {
...
/// - returns: A new expression with the inset edges.
///
@discardableResult public func inset(_ edges: Edges, _ insets: UIEdgeInsets) -> Expression<Edges> {
